<div>
            ...
            <form class="relative mx-auto" autocomplete="off" wire:submit.prevent="update">
                <div class="grid grid-cols-5 gap-2">
                    <div class="form-group">
                        ...
                        <label>Número</label>
                        <input type="text" class="w-full border-[1.5px] border-gray-300 bg-white h-10 px-2.5 pr-16 rounded-lg text-sm focus:outline-none focus:border-sky-500" placeholder="Ingrese el número de crédito" wire:model="number">
                        @error('number')
                    ...
                    <div class="form-group col-span-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            @can('authenticate.credit.update')
                            <div>

                                <button class="btn btn-primary">Actualizar crédito</button>
                            </div>
                            @endcan
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::open(['route' => ['authenticate.credit.upload', $credit], 'files' => true]) !!}
            ...
            @if ($credit->file()->where('status',true)->get() )
                ...
                <div>
                    ...
                    <div class="border rounded-lg mt-2">
                        ...
                        @foreach ($credit->file()->where('status',true)->get() as $file)
